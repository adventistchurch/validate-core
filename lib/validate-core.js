...
var date = (function (value, options) {
  return datetime(value, _objectSpread2({}, options, {
    dateOnly: true
  }));
});
...
var email = (function (value, options) {
  var _defaults$options = _objectSpread2({}, defaults$1, {}, options),
      message = _defaults$options.message,
...
var equality = (function (value, options) {
  ...
  var _defaults$options = _objectSpread2({}, defaults$2, {}, options),
...
var exclusion = (function (value, options) {
  ...
  var _defaults$options = _objectSpread2({}, defaults$3, {}, options),
...
var format = (function (value, options) {
  ...
  var _defaults$options = _objectSpread2({}, defaults$4, {}, options),
      message = _defaults$options.message,
...
var inclusion = (function (value, options) {
  ...
  var _defaults$options = _objectSpread2({}, defaults$5, {}, options),
      message = _defaults$options.message,
      within = _defaults$options.within,
...
var length = (function (value, options) {
  var _defaults$options = _objectSpread2({}, defaults$6, {}, options),
...
var numericality = (function (value, options) {
  ...
  var _defaults$options = _objectSpread2({}, defaults$7, {}, options),
...
var presence = (function (value, options) {
  var _defaults$options = _objectSpread2({}, defaults$8, {}, options),
      allowEmpty = _defaults$options.allowEmpty,
      message = _defaults$options.message;
...
var type = (function (value, options) {
  ...
  var _defaults$options = _objectSpread2({}, defaults$9, {}, options),
      message = _defaults$options.message,
...
var url = (function (value, options) {
  var _defaults$options = _objectSpread2({}, defaults$a, {}, options),
